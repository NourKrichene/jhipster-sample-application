...
import com.nour.agiliti.repository.TaskRepository;
...
/**
 * REST controller for managing {@link com.nour.agiliti.domain.Task}.
 */
@RestController
@RequestMapping("/api")
        ...
        Optional<Task> result = taskRepository
            ...
            .map(existingTask -> {
                ...
                if (task.getArchived() != null) {
                    existingTask.setArchived(task.getArchived());
                }
