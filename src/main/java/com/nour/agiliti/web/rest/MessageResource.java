...
/**
 * REST controller for managing {@link com.nour.agiliti.domain.Message}.
 */
@RestController
@RequestMapping("/api")
    ...
    public ResponseEntity<Message> partialUpdateMessage(
        ...
        Optional<Message> result = messageRepository
            ...
            .map(existingMessage -> {
                ...
                if (message.getArchived() != null) {
                    existingMessage.setArchived(message.getArchived());
                }
                if (message.getReaad() != null) {
                    existingMessage.setReaad(message.getReaad());
                }
